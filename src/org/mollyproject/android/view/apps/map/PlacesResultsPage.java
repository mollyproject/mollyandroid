...
public class PlacesResultsPage extends ContentPage {
	...
	private class PlacesResultsTask extends BackgroundTask<Void,Void,JSONObject>
	{
		public PlacesResultsTask(Page page, boolean toDestroyPageAfterFailure,
		...
		public void updateView(JSONObject outputs) {
			try {
		        ...
		        ItemizedIconOverlay<OverlayItem> overlay = new ItemizedIconOverlay<OverlayItem>(PlacesResultsPage.this,overlayItems, null);
