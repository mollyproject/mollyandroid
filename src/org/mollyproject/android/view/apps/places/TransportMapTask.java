...
import org.mollyproject.android.view.apps.transport.bus.BusTask;
import org.mollyproject.android.view.apps.transport.train.TrainPageRefreshTask;
import org.mollyproject.android.view.apps.transport.train.TrainTask;
...
public class TransportMapTask extends BackgroundTask<JSONObject,Void,JSONObject>{
	...
	protected JSONObject doInBackground(JSONObject... params) {
		try
		{
			...
			{
				JSONObject jsonContent = MyApplication.router.requestJSON(page.getName(), page.getAdditionalParams(), page.getQuery());
				MyApplication.transportCache = jsonContent;
				return jsonContent;
			}
