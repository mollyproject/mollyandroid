...
public class CookieManager {
     ...
     */
    public void storeCookies(URLConnection conn) throws IOException, JSONException {
    ...
    {
    	return (String) ((Map)((Map) store.get(getDomainFromHost(url.getHost()))).get("csrftoken")).get("csrftoken");
    }
